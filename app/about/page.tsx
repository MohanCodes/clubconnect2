      ...
      <main className="flex-grow flex items-center justify-center px-4 py-16">
        <div className='max-w-3xl w-full'>
          ...
          <div className="space-y-12">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-azul mb-4">How to Use ClubConnect</h2>
              <p className="text-grey mb-6">
                Follow these steps to make the most out of ClubConnect:
              </p>
              <ol className="list-decimal list-inside text-grey">
                ...
                <li>Promote your own club by creating a profile and adding it to the ClubConnect database.</li>
