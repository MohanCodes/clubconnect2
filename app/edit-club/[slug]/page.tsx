...
const EditClubPage = () => {
  ...
  const templateDescriptions: Record<TemplateNumber, string> = {
      ...
      2: "The {clubName} is an engaging community focused on __. We meet bi-weekly on __ at __ to plan and participate in activities such as __, __, and __. Members are encouraged to attend regularly and contribute their ideas, but we understand that life can get busy! If you're looking to make new friends while exploring your interests, this club is for you.",
      3: "The {clubName} is a dedicated group committed to __ and making a meaningful impact in our school community. We meet weekly on __ at __, where we engage in planning extensive projects, events, and initiatives such as __, __, and __. Members are expected to actively participate and contribute their time and talents. If you're passionate about __ and ready to take on challenges, we'd love for you to join us!"
  };
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <p className="text-grey">
                  ...
                  <Link href="mailto:mohan@mnclubconnect.com" className="text-azul hover:underline">
