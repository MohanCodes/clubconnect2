...
import { FaEnvelope, FaCalendarAlt, FaClock, FaMapMarkerAlt, FaUserGraduate, FaDollarSign, FaPlus, FaTrash, FaTwitter, FaInstagram, FaFacebook, FaLinkedin, FaYoutube, FaDiscord, FaGithub, FaTiktok, FaGlobe, FaUser, FaLink } from 'react-icons/fa';
...
const BiologyClubPage: React.FC = () => {
  ...
  const [clubInfo, setClubInfo] = useState<ClubInfo>({
    name: "Biology Club",
    tags: ["Science", "Biology", "Research", "Experiments", "Academic"],
    description: "Bio Club is a student-driven organization that explores various topics in biology...",
    length: "Academic school year",
    meetingTimes: "Most Mondays",
    meetingSite: "A403",
    eligibility: "Grades 9-12",
    costs: "Participation fee",
    advisors: [{ name: "Dan Dobson", email: "Dan.Dobson@wayzataschools.org" }],
    studentLeads: [
    ...
    links: [
      { url: "https://twitter.com/bioclub", platform: "twitter" },
      { url: "https://instagram.com/bioclub", platform: "instagram" },
    ],
  });
