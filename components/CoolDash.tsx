            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="bg-tilegrey rounded-xl p-6 mb-8">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <button className="bg-azul text-white px-4 py-2 rounded-xl">Create Event</button>
                        <button className="bg-azul text-white px-4 py-2 rounded-xl">Update Profile</button>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {[{ id: '1', name: 'Club A', tags: ['tag1'], upvoteCount: 10 },
                          { id: '2', name: 'Club B', tags: ['tag1', 'tag2'], upvoteCount: 5 }].map((club) => (
                            <div key={club.id} 
                                 className="bg-[#3A3A3A] p-4 rounded-xl cursor-pointer transition-transform transform hover:scale-[1.02]">
